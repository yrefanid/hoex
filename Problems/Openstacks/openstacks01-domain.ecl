...
operator(make_product_p5,
	[not_made(p5), started(o5)],
	[not_made(p5)],
	[made(p5)]).
...
operator(ship_order_o5(Avail,NewAvail),
	[started(o5), made(p5), stacks_avail(Avail)],
	[started(o5), stacks_avail(Avail)],
	[shipped(o5), stacks_avail(NewAvail)]):-
	count(Avail), count(NewAvail), next_count(Avail, NewAvail).
